  ...
  return (
    <div className="bg-background-light dark:bg-background-dark font-display text-[#101718] dark:text-gray-100 min-h-screen">
      <div className="flex min-h-screen w-full flex-col lg:flex-row">
        ...
        {/* LEFT SIDE (DESKTOP ONLY – SAME DESIGN) */}
        <div className="hidden lg:flex lg:w-[55%] bg-gradient-to-br from-teal-700 via-teal-600 to-emerald-600 relative overflow-hidden flex-col justify-between p-16">
          ...
          <div className="relative z-10">
            ...
            <p className="text-white/80 text-xl font-light max-w-md leading-relaxed">
              A smart attendance decision system that helps you maintain your
              academic integrity without missing the moments that matter.
            </p>
          </div>
        ...
        <div className="flex-1 flex flex-col items-center justify-start lg:justify-center p-8 sm:p-12 lg:p-24 bg-background-light dark:bg-background-dark">
          ...
          <div className="w-full max-w-[440px]">
            ...
            <form className="space-y-5">
              ...
              {/* Button */}
              <button className="w-full flex items-center justify-center rounded-lg h-12 px-5 bg-primary bg-[#337f94] hover:bg-[#255d6d] text-white text-base font-bold transition-all shadow-md shadow-primary/20">
                Sign In
              </button>
            </form>
