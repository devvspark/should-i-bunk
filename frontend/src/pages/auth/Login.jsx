        ...
        <div className="flex-1 flex flex-col items-center justify-start lg:justify-center p-8 sm:p-12 lg:p-24 bg-background-light dark:bg-background-dark">
          ...
          <div className="w-full max-w-[440px]">
            ...
            <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <button
                disabled={loading}
                className="w-full flex items-center justify-center rounded-lg h-12 px-5 bg-primary bg-[#337f94] hover:bg-[#255d6d] text-white text-base font-bold transition-all shadow-md shadow-primary/20 disabled:opacity-60"
              >
