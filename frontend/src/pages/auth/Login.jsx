          ...
          <div className="w-full max-w-[440px]">
            ...
            <form className="space-y-5">
              ...
              <div className="flex items-center gap-2">
                ...
                <label className="text-sm text-gray-500 dark:text-gray-400">Keep me logged in</label>
              </div>

              {/* Button */}
              <button className="w-full h-12 bg-primary hover:bg-[#255d6d] text-white font-bold rounded-lg shadow-md shadow-primary/20">
                Sign In
              </button>
              ...
              {/* Google */}
              <button className="flex items-center justify-center gap-2 w-full h-12 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700">
                <img
            ...
            <p className="mt-10 text-center text-sm text-gray-500 dark:text-gray-400">
              ...
              <a href="#" className="text-primary font-bold ml-1 hover:underline">
                Create an account
              </a>
            </p>
          </div>
